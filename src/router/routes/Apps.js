...
const LeadView = lazy(() => import('../../views/apps/lead/view'))

const Roles = lazy(() => import('../../views/apps/roles-permissions/roles'))
const Permissions = lazy(() => import('../../views/apps/roles-permissions/permissions'))

const LeadList = lazy(() => import('../../views/apps/lead/list'))

const ContactList = lazy(() => import('../../views/apps/contact/list'))
const ContactView = lazy(() => import('../../views/apps/contact/view'))
